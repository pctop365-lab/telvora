...
const paymentOptions = [
  {
    value: 'sbp',
    label: 'СБП — после согласования',
    desc: 'Реквизиты и возможность оплаты подтвердит менеджер; оплата на сайте недоступна',
    icon: CreditCard,
  },
  {
    value: 'cash',
    label: 'Наличными — после согласования',
    desc: 'Возможность и порядок оплаты подтвердит менеджер',
    icon: Banknote,
  },
];
