...
check(str_contains($source,".footer {\n    margin-top: 10mm;"),'footer top margin must remain 10mm');
check(str_contains($source,".footer-logo {\n    width: 50mm;"),'footer logo width must remain 50mm');
