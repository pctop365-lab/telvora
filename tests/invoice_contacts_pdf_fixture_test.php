...
<table class="info"><tr><td class="label">Продавец / ИНН / Реквизиты</td><td>TELVORA</td></tr><tr><td class="label">Телефон</td><td>' . htmlspecialchars($contacts['phoneDisplay']) . '</td></tr><tr><td class="label">Почта</td><td>' . $emailLine . '</td></tr><tr><td class="label">Адрес</td><td>г. Москва, Багратионовский проезд</td></tr></table>
