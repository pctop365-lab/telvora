...
const catalog={success:true,services:[
  {id:1,service_key:'wall-mount-55-64',category:'mounting',name:'Монтаж телевизора на стену',description:'Монтаж на подготовленное место.',min_screen_size:55,max_screen_size:64,price:10000,is_active:true,sort_order:1,requires_tv:true},
